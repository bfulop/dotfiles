...
hi Normal ctermfg=243 ctermbg=254 guifg=#557498 guibg=#EDEBE9
...
hi Folded ctermfg=243 ctermbg=188 cterm=NONE guifg=#929cad  guibg=#EDEBE9 gui=NONE
hi FoldColumn ctermfg=243 ctermbg=254 cterm=NONE guifg=#697383 guibg=#EDEBE9 gui=NONE
...
hi VertSplit ctermfg=188 ctermbg=188 cterm=NONE guifg=#dfddd7 guibg=#EDEBE9 gui=NONE
hi LineNr ctermfg=145 ctermbg=188 cterm=NONE guifg=#bdbbb6 guibg=#EDEBE9 gui=NONE
...
hi LspDiagnosticsError ctermfg=188 ctermbg=66 guifg=#bdbbb6 gui=italic
...
hi Todo ctermfg=243 ctermbg=254 cterm=bold guifg=#697383 guibg=#EDEBE9 gui=bold
hi IncSearch ctermfg=254 ctermbg=66 cterm=bold guifg=#EDEBE9 guibg=#9784ae gui=bold
hi Search ctermfg=254 ctermbg=30 cterm=NONE guifg=#EDEBE9 guibg=#aa586e gui=NONE
...
hi TabLine ctermfg=243 ctermbg=254 cterm=NONE guifg=#697383 guibg=#EDEBE9 gui=NONE
hi TabLineSel ctermfg=254 ctermbg=132 cterm=bold guifg=#EDEBE9 guibg=#a05b89 gui=bold
hi TabLineFill ctermfg=243 ctermbg=254 cterm=NONE guifg=#697383 guibg=#EDEBE9 gui=NONE
...
hi SignColumn ctermfg=243 ctermbg=188 cterm=NONE guifg=#697383 guibg=#EDEBE9 gui=NONE
...
hi jsNoise ctermfg=243 ctermbg=188 cterm=NONE guifg=#929cad  guibg=#EDEBE9 gui=NONE
hi Noise ctermfg=243 ctermbg=188 cterm=NONE guifg=#929cad  guibg=#EDEBE9 gui=NONE
hi jsArguments ctermfg=243 ctermbg=254 guifg=#929cad guibg=#EDEBE9 gui=italic
hi jsFuncArgs ctermfg=243 ctermbg=254 guifg=#929cad guibg=#EDEBE9 gui=italic
hi jsArrowFuncArgs ctermfg=243 ctermbg=254 guifg=#929cad guibg=#EDEBE9 gui=italic
hi jsObjectKey ctermfg=243 ctermbg=254 guifg=#56759a  guibg=#EDEBE9 gui=bold
hi jsFuncCall ctermfg=243 ctermbg=254 guifg=#697383  guibg=#EDEBE9 gui=bolditalic

hi markdownBold ctermfg=243 ctermbg=254 guifg=#56759a  guibg=#EDEBE9 gui=bold cterm=bold
hi mkdBold ctermfg=243 ctermbg=254 guifg=#697383 guibg=#EDEBE9 gui=bold cterm=bold
hi htmlBold ctermfg=243 ctermbg=254 guifg=#697383 guibg=#EDEBE9 gui=bold cterm=bold
hi markdownItalic ctermfg=243 ctermbg=254 guifg=#56759a  guibg=#EDEBE9 gui=italic cterm=italic
hi mkdItalic ctermfg=243 ctermbg=254 guifg=#697383 guibg=#EDEBE9 gui=italic cterm=italic
hi htmlItalic ctermfg=243 ctermbg=254 guifg=#697383 guibg=#EDEBE9 gui=italic cterm=italic
hi markdownCode ctermfg=243 ctermbg=254 guifg=#56759a  guibg=#EEEDEB gui=NONE
hi markdownCodeDelimiter ctermfg=243 ctermbg=254 guifg=#56759a  guibg=#EEEDEB gui=NONE

hi mkdCode ctermfg=243 ctermbg=254 guifg=#929cad  guibg=#EDEBE9 gui=bold
hi mkdCodeStart ctermfg=243 ctermbg=188 cterm=NONE guifg=#929cad  guibg=#EDEBE9 gui=NONE
hi mkdCodeEnd ctermfg=243 ctermbg=188 cterm=NONE guifg=#929cad  guibg=#EDEBE9 gui=NONE
hi mkdIndentCode ctermfg=243 ctermbg=254 guifg=#56759a  guibg=#EEEDEB gui=NONE
hi mkdBlockquote ctermfg=243 ctermbg=254 guifg=#56759a  guibg=#EEEDEB gui=NONE

hi Cursor guifg=white guibg=#DC7786
hi Cursor2 guifg=red guibg=#02E0A9 
