...
call s:hi('VertSplit',  { 'guifg': s:dark_gray, 'guibg': s:black})
...
call s:hi('Folded',     { 'guifg': s:dark_green, 'guibg': 'bg'})
...
call s:hi('MatchParen', { 'guifg': s:yellow})
...
call s:hi('NonText',    { 'guifg': s:dark_gray })
call s:hi('Comment',    { 'guifg': s:gray, 'gui': 'italic' })
call s:hi('Constant',   { 'guifg': s:magenta,  'guibg': '#2F3A44' })
call s:hi('Statement',  { 'guifg': s:dark_green, 'gui': 'bold' })
call s:hi('PreProc',    { 'guifg': s:dark_green })
call s:hi('Type',       { 'guifg': s:magenta, })
call s:hi('Identifier', { 'guifg': s:purple, 'gui': 'bold' })
call s:hi('Function',   { 'guifg': s:yellow, 'gui': 'bold,italic' })
call s:hi('Conceal',    { 'guifg': s:dark_gray, 'guibg': 'NONE' })
call s:hi('Special',    { 'guifg': s:yellow, 'gui': 'bold' })
call s:hi('Title',      { 'guifg': s:purple })

" my javascript stuff
call s:hi('jsFuncCall', { 'guifg': s:green, 'gui': 'bold,italic' })
call s:hi('javascriptVariable',      { 'guifg': s:red })
call s:hi('javascriptIdentifier',      { 'guifg': s:red })
call s:hi('jsGlobalObjects',      { 'guifg': s:purple })
call s:hi('javascriptArrowFunc',      { 'guifg': s:yellow })
call s:hi('javascriptObjectLabel',      { 'guifg': s:yellow })
call s:hi('javascriptPropertyName',      { 'guifg': s:yellow })
call s:hi('jsObjectFuncName',      { 'guifg': s:green })
call s:hi('jsObjectKey',      { 'guifg': s:yellow, 'gui': 'bold' })
call s:hi('jsObjectKey',      { 'guifg': s:yellow, 'gui': 'bold' })
call s:hi('jsObjectKey',      { 'guifg': s:yellow, 'gui': 'bold' })
call s:hi('jsVariableDef',      { 'guifg': s:yellow })
call s:hi('jsOperator',      { 'guifg': s:purple })
call s:hi('jsBlockLabel',      { 'guifg': s:purple })
call s:hi('jsStatement',      { 'guifg': s:purple })
call s:hi('jsFuncArgs',      { 'guifg': s:purple, 'gui': 'italic' })
" call s:hi('jsObject',      { 'guifg': s:purple, 'gui': 'bold' })
call s:hi('jsArrowFunction',      { 'guifg': s:yellow, 'gui': 'bold' })
